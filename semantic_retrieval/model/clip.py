...
from .modules import VisionTransformer, Transformer
...
class CLIP(nn.Module):
    def __init__(
        ...
        self.image_projection = nn.Parameter(torch.empty(vision_emb_dim, emb_dim))
    ...
    def init_weights(self):
        ...
        nn.init.normal_(self.image_projection, std=self.vision.emb_dim ** -0.5)
        nn.init.normal_(self.text_projection, std=self.text.emb_dim ** -0.5)