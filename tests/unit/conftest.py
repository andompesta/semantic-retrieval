...
def spark() -> SparkSession:
    ...
    :return: SparkSession
    """
    print("Configuring Spark session for testing environment")
...
def mlflow_local():
    ...
    * Active run will be automatically stopped to avoid verbose errors.
    :return: None
    """
    print("Configuring local MLflow instance")
    ...
    print("MLflow instance configured")
    yield None
    ...
    print("Test session finished, unrolling the MLflow instance")
...
def dbutils_fixture() -> Iterator[None]:
    ...
    :return:
    """
    print("Patching the DBUtils object")
    with patch("src.common.get_dbutils", lambda _: DBUtilsFixture()):
        yield
    print("Test session finished, patching completed")
